...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1035, 923)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.pushButton_Start = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Start.setGeometry(QtCore.QRect(510, 470, 271, 51))
        self.pushButton_Start.setObjectName("pushButton_Start")
        self.groupBox_OtherSettings = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_OtherSettings.setGeometry(QtCore.QRect(640, 10, 381, 321))
        ...
        self.checkBox_WindowMode = QtWidgets.QCheckBox(self.layoutWidget)
        self.checkBox_WindowMode.setObjectName("checkBox_WindowMode")
        self.verticalLayout.addWidget(self.checkBox_WindowMode)
        ...
        self.groupBox_Cutters.setGeometry(QtCore.QRect(360, 110, 231, 121))
        self.groupBox_Cutters.setObjectName("groupBox_Cutters")
        self.layoutWidget1 = QtWidgets.QWidget(self.groupBox_Cutters)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 30, 210, 89))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 400, 341, 231))
        self.groupBox_2.setObjectName("groupBox_2")
        self.textEdit_SitesAddresses = QtWidgets.QTextEdit(self.groupBox_2)
        self.textEdit_SitesAddresses.setGeometry(QtCore.QRect(10, 20, 321, 201))
        ...
        self.groupBox_Browsers.setGeometry(QtCore.QRect(360, 240, 191, 91))
        self.groupBox_Browsers.setObjectName("groupBox_Browsers")
        self.layoutWidget3 = QtWidgets.QWidget(self.groupBox_Browsers)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 30, 146, 57))
        ...
        self.groupBox_SavePath.setGeometry(QtCore.QRect(360, 350, 551, 101))
        ...
        self.label_WaitFinish.setGeometry(QtCore.QRect(420, 530, 451, 51))
        self.label_WaitFinish.setLineWidth(4)
        self.label_WaitFinish.setTextFormat(QtCore.Qt.PlainText)
        self.label_WaitFinish.setAlignment(QtCore.Qt.AlignCenter)
        self.label_WaitFinish.setObjectName("label_WaitFinish")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 640, 441, 221))
        self.groupBox_3.setObjectName("groupBox_3")
        self.tableWidget = QtWidgets.QTableWidget(self.groupBox_3)
        self.tableWidget.setGeometry(QtCore.QRect(10, 20, 421, 191))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_WindowMode.setText(_translate("MainWindow", "Window screen mode"))
        ...
        self.label_WaitFinish.setText(_translate("MainWindow", "test"))
